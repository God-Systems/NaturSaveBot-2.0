    ...
    async def on_new_message(event: events.NewMessage.Event) -> None:
        ...
        try:
            ...
            async with get_session() as session:
                ...
                if save_mode_allowed or is_hard_muted:
            ...
            if hard_notice:
                ...
                await _notify_hard_mute(bot, owner_id, hard_event, notice_media, notice_chat_title, delete_result, settings.timezone)
                return
...
async def _notify_hard_mute(
    ...
    body = (
        ...
        f"Время: <code>{_format_local(hard_event.created_at, timezone_name)}</code>\n\n"
